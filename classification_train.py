...
## Data loading
dset_train = ModelNet40(data_dir=data_dir, split='train', samples_per_class=samples_per_class_train)
dset_test = ModelNet40(data_dir=data_dir, split='test', samples_per_class=samples_per_class_test)
...
results_dir_current = os.path.join(results_dir, f'results_{current_time}')
...
print(f"🎉​ Training completed! Results saved in {results_dir_current}")