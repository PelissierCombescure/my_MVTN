...
## Opitmize code 1/3
train_loader = CustomDataLoader(dset_train, batch_size=32, shuffle=True, drop_last=False, pin_memory=True)
test_loader = CustomDataLoader(dset_test, batch_size=32, shuffle=False, drop_last=False, pin_memory=True)
...
for epoch in range(epochs):
    ...
    if True:
        ...
        if test_accuracy > best_accuracy:
            ...
            torch.save(mvnetwork.state_dict(), results_dir_current+f'/best/mvnetwork_best.pth')
            torch.save(mvtn.state_dict(), results_dir_current+f'/best/mvtn_best.pth')
            torch.save(mvrenderer.state_dict(), results_dir_current+f'/best/mvrenderer_best.pth')
