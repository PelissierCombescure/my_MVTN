...
for epoch in range(epochs):
    ...
    if True:
        ...
        if test_accuracy > best_accuracy:
            ...
            torch.save(mvnetwork.state_dict(), results_dir_current+'/best/mvnetwork_best.pth')
            torch.save(mvtn.state_dict(), results_dir_current+'/best/mvtn_best.pth')
            torch.save(mvrenderer.state_dict(), results_dir_current+'/best/mvrenderer_best.pth')
            print(f"Best epoch saved with accuracy: {best_accuracy:.2f}%")
